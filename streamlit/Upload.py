...
def speaker_diarization(aws_mp3_file, language):
    ...
    segmented_audio_to_whisper_api(speaker_labels_string, filename, language)
...
def read_audio_file_from_s3(file_name, language):
    try:
        ...
        speaker_diarization(aws_filepath, language)
        return True
...
if st.button('Upload'):
    if audio_file is None:
        ...
        if 'Contents' in response:
            ...
            # Call the DAG
            read_audio_file_from_s3(audio_file.name, language)
